...
//                //
//
////                MyDoes p = dataSnapshot.getRef().child()getValue(MyDoes.class);
////
////
////                Log.d("GET VALUE", dataSnapshot.toString());
////                    list.add(dataSnapshot.getValue(MyDoes.class));
////
////                //}
////
...
////                doesAdapter = new DoesAdapter(MainActivity.this, list);
////
////                Log.d("THE ADAPTER!!!", doesAdapter.getMyDoes().toString());
////
////                ourdoes.setAdapter(doesAdapter);
////                doesAdapter.notifyDataSetChanged();
//            }
